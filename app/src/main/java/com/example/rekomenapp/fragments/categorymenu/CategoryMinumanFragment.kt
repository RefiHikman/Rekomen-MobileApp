 ...
 * Use the [CategoryMinumanFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CategoryMinumanFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewOfLayout = inflater.inflate(R.layout.fragment_category_minuman, container, false)

        // FIREBASE REFERENCE
        dbRef = FirebaseDatabase.getInstance().getReference("Review")

        val seeAll2 = viewOfLayout.findViewById<TextView>(R.id.seeAll2)
        ...
        gridItem1.setOnClickListener {
            ...
            intent.putExtra("category", "Minuman")
            intent.putExtra("subcategory", "Bajigur")
        ...
        gridItem2.setOnClickListener {
            ...
            intent.putExtra("category", "Minuman")
            intent.putExtra("subcategory", "Bandrek")
        ...
        gridItem3.setOnClickListener {
            ...
            intent.putExtra("category", "Minuman")
            intent.putExtra("subcategory", "Cendol")
        ...
        gridItem4.setOnClickListener {
            ...
            intent.putExtra("category", "Minuman")
            intent.putExtra("subcategory", "Es Teh")
        ...
        gridItem5.setOnClickListener {
            ...
            intent.putExtra("category", "Minuman")
            intent.putExtra("subcategory", "Thai Tea")
        ...
        gridItem6.setOnClickListener {
            ...
            intent.putExtra("category", "Minuman")
            intent.putExtra("subcategory", "Kopi")
    ...
    private fun getRandomReview() {
        ...
        val query = dbRef.orderByChild("reviewCategory").equalTo("Minuman")
    ...
    companion object {
         ...
         * @return A new instance of fragment CategoryMinumanFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CategoryMinumanFragment().apply {
