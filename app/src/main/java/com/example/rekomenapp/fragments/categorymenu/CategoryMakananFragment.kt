 ...
 * Use the [CategoryMakananFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CategoryMakananFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewOfLayout = inflater.inflate(R.layout.fragment_category_makanan, container, false)

        // FIREBASE REFERENCE
        dbRef = FirebaseDatabase.getInstance().getReference("Review")

        // VIEWS
        val seeAll1 = viewOfLayout.findViewById<TextView>(R.id.seeAll1)
        ...
        gridItem1.setOnClickListener {
            ...
            intent.putExtra("category", "Makanan")
            intent.putExtra("subcategory", "Martabak")
        ...
        gridItem2.setOnClickListener {
            ...
            intent.putExtra("category", "Makanan")
            intent.putExtra("subcategory", "Es Krim")
        ...
        gridItem3.setOnClickListener {
            ...
            intent.putExtra("category", "Makanan")
            intent.putExtra("subcategory", "Donat")
        ...
        gridItem4.setOnClickListener {
            ...
            intent.putExtra("category", "Makanan")
            intent.putExtra("subcategory", "Mie Ayam")
        ...
        gridItem5.setOnClickListener {
            ...
            intent.putExtra("category", "Makanan")
            intent.putExtra("subcategory", "Burger")
        ...
        gridItem6.setOnClickListener {
            ...
            intent.putExtra("category", "Makanan")
            intent.putExtra("subcategory", "Nasi Goreng")
    ...
    private fun getRandomReview() {
        ...
        val query = dbRef.orderByChild("reviewCategory").equalTo("Makanan")
        query.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                if (snapshot.exists()) {
                    ...
                    randomQuery.addListenerForSingleValueEvent(object : ValueEventListener {
                            ...
                            override fun onCancelled(error: DatabaseError) {
                                Log.e(TAG, "Error fetching review", error.toException())
                            }
                        })
                }
            ...
            override fun onCancelled(error: DatabaseError) {
                Log.e(TAG, "Error fetching random review", error.toException())
            }
        })
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CategoryMakananFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CategoryMakananFragment().apply {
