 ...
 * Use the [CategoryRefreshingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CategoryRefreshingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewOfLayout = inflater.inflate(R.layout.fragment_category_refreshing, container, false)

        // FIREBASE REFERENCE
        dbRef = FirebaseDatabase.getInstance().getReference("Review")

        val seeAll3 = viewOfLayout.findViewById<TextView>(R.id.seeAll3)
        ...
        seeAll3.setOnClickListener{
            val intent = Intent(activity, ReadActivity::class.java)

            intent.putExtra("category", "Refreshing")
        ...
        gridItem1.setOnClickListener {
            ...
            intent.putExtra("category", "Refreshing")
            intent.putExtra("subcategory", "Icon Kota")
        ...
        gridItem2.setOnClickListener {
            ...
            intent.putExtra("category", "Refreshing")
            intent.putExtra("subcategory", "Museum")
        ...
        gridItem3.setOnClickListener {
            ...
            intent.putExtra("category", "Refreshing")
            intent.putExtra("subcategory", "Daerah")
        ...
        gridItem4.setOnClickListener {
            ...
            intent.putExtra("category", "Refreshing")
            intent.putExtra("subcategory", "Perkebunan")
        ...
        gridItem5.setOnClickListener {
            ...
            intent.putExtra("category", "Refreshing")
            intent.putExtra("subcategory", "Masjid")
        ...
        gridItem6.setOnClickListener {
            ...
            intent.putExtra("category", "Refreshing")
            intent.putExtra("subcategory", "Taman")
    ...
    private fun getRandomReview() {
        ...
        val query = dbRef.orderByChild("reviewCategory").equalTo("Refreshing")
    ...
    companion object {
         ...
         * @return A new instance of fragment CategoryRefreshingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CategoryRefreshingFragment().apply {
